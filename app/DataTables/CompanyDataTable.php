...
class CompanyDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('action', function ($data) {
             $id = $data->blog_id;
             $edit = '<a class="label label-success badge badge-light-success" href="' . route('company.edit',$id) . '"  title="Update"><i class="fa fa-edit"></i>&nbsp</a>';
             ...
             $view = '<a class="label label-primary badge badge-light-primary" href="'. route('company.show',$id).'"  title="View"><i class="fa fa-eye"></i>&nbsp</a>';
